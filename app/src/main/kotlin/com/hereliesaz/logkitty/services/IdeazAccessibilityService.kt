...
class IdeazAccessibilityService : AccessibilityService() {
    ...
    private val tapReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            if (intent?.action == "com.hereliesaz.logkitty.INTERNAL_TAP_DETECTED") {
    ...
    override fun onServiceConnected() {
        ...
        val filter = IntentFilter("com.hereliesaz.logkitty.INTERNAL_TAP_DETECTED")
    ...
    private fun inspectAt(x: Int, y: Int) {
        ...
        if (leaf != null) {
            ...
            val intent = Intent("com.hereliesaz.logkitty.PROMPT_SUBMITTED_NODE").apply {
